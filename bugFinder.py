...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 19 13:16:57 2018
...
class BranchingFW:
    ...
    def __init__(self, steps=10, outputsize=(500,500), dim=2, prob=20, filename="blank"):
    ...
    def step(self, pos):
        #self.__lattice.display(outputsize=(500,500))
...
for i in range(0, 11):
    ...
    FW = BranchingFW(prob=0, steps=i, filename="forPresentation_expansion_"+str(i))
    state = FW.get_random_state()         